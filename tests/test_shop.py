...
def test_search_filters_by_keyword(client, category, subcategory):
...
def test_product_list_price_filter(client, category, subcategory):
...
def test_product_list_on_sale_filter(client, category, subcategory):
...
def test_out_of_stock_product_shows_badge(client, category, subcategory):
...
def test_inactive_product_not_listed(client, category, subcategory):
...
def test_pagination_limits_products_per_page(client, category, subcategory):
    for i in range(15):
